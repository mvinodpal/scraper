...
/*$state_id_array=array("31","26","22","29","14","18","33","7","11","10","9","35","15","21","13","17","27","23","25","24","20","8","19","32","16","28","12","34","30");*/ // Default List

$state_id_array=array("31","26","22","29","14","18","33","7","11","10","9","35","15","21","13","17","27","23","25","24","20","8","19","32","16","28","12","34","30");

/*$looking_for_array = array("1","2","13","3","14","15","4","6","10");*/ //Default List
$looking_for_array = array("10");
...
foreach ($state_id_array as $state_id) {
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://www.whirlpoolindia.com/ajax_city_list.php?stateID=$state_id&b=02&catID=$looking_for",
			  	...
			  	foreach($location_id_array as $location){
						...
						if ($err) {
						  ...
						  $body = $response;
								...
								$file_handler = fopen('D:\\wamp\\www\\whr1\\data\\'.$state_id.'_'.$city.'_'.$location.'_'.$looking_for.'.html', 'a') or die('Unable to open file!');
	...
	echo "category for : ". $looking_for . " ____DONE____";
	 die;
}//
